        ...
        <div className="relative z-20 mx-auto max-w-5xl rounded-[40px] py-6 md:p-10 xl:py-20">
          <div className="space-y-4 md:space-y-6">
            <p className="text-base md:text-xl lg:text-2xl xl:text-3xl text-white/90 [text-shadow:_0_2px_10px_rgb(0_0_0_/_50%)] font-open-sans-custom leading-relaxed">
              Мы собрали лучшие рецепты русской кухни — от наваристого борща и сочных пельменей до утончённого бефстроганова. Каждый рецепт сопровождается историей: из какого города или региона России пришло это блюдо.
            </p>
            <p className="text-base md:text-xl lg:text-2xl xl:text-3xl text-white/90 [text-shadow:_0_2px_10px_rgb(0_0_0_/_50%)] font-open-sans-custom leading-relaxed">
              Начинающий кулинар или опытный повар — вы найдёте рецепт по душе: простые блюда на каждый день и сложные шедевры для особых случаев. Готовьте с удовольствием на аэрогриле, мультиварке и плите!
            </p>
          </div>
        </div>
      </div>
